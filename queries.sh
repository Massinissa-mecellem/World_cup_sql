...
echo "$($PSQL "SELECT DISTINCT name FROM teams JOIN games g ON teams.team_id = g.winner_id or teams.team_id = g.opponent_id  WHERE round = 'Eighth-Final' AND year = 2014")"
